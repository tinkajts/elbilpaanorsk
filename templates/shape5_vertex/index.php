...
<?php if ($browser == "ie7" || $browser == "ie8") { ?>
#s5_header_area_inner2, #s5_header_wrap, #s5_search input, .module_round_box, .module_round_box-dark, #s5_component_wrap, #s5_footer_area_inner2, .padded, .padded:hover {
