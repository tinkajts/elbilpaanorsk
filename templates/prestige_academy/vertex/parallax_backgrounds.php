...
<?php } ?>
	function s5_parallax_scroll_handler() {
		...
		s5_check_parallax_scroll("s5_bottom_row1_area2");
		<?php } ?>
		...
		s5_check_parallax_scroll("s5_bottom_row3_area2");
		<?php } ?>
    } 
