  ...
  g.fn.vertexToggle = function (d) {
    ...
    this.each(function () {
      ...
      if(b.prop('tagName') == 'INPUT') {
        var c = b.prop('id');
        var l = jQuery('<label />').prop('for', c).addClass('vertexToggle');
        b.before(l);
        l.click(function() {
          console.log('click');
          slide(g(this));
        ...
        b.children('input:' + settings.type).each(function () {
          var a = g(this).prop('id');
          g(this).before('<label class="vertexToggle" for="' + a + '"></label>');
